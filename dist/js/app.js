...
(function ($) {
  $(function () {
    ...
    var baseAnimationDelay = 200;
    var nextElementAdditionalDelay = baseAnimationDelay / 2;
    ...
    var heroSlider = $('.regular-content__slider').slick({
      infinite: true,
      slidesToShow: 1,
      slidesToScroll: 1,
      speed: 600,
    ...
    var featuredLocationSlider = $('.featured-locations-slider').slick({
      infinite: true,
      slidesToShow: 1,
      slidesToScroll: 1,
      speed: 600,
    ...
    $(window).scroll(function () {
      ...
      if (scroll > 32) sticky.addClass('fixed');else sticky.removeClass('fixed');
    });
    ...
    window.addEventListener("scroll", function () {
      $('.regular-content').each(function () {
        ...
        if (topDistance < section.offset().top + section.outerHeight() && topDistance + $(window).height() > section.offset().top) {
    ...
    $('.regular-content:not(#footer)').each(function () {
      var section = $(this);
      var section__main = section.find('.regular-content__main');
      var title_and_content_tags = section__main.find('h1, h2, h3, h4, h5, h6, p, label, .subheading, .link, .link-large');
      var button_tags = section__main.find('button, .btn');
    ...
    if (document.getElementById("map") && window.gmapsettings != undefined) {
      var initMap = /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var _yield$google$maps$im, Map, latLng;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                latLng = {
                  lat: window.gmapsettings.latitude,
                  lng: window.gmapsettings.longitude
                };
...
function RGBAToHexA(rgba) {
  var forceRemoveAlpha = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  return "#" + rgba.replace(/^rgba?\(|\s+|\)$/g, '') // Get's rgba / rgb string values
  .split(',') // splits them at ","
  .filter(function (string, index) {
    return !forceRemoveAlpha || index !== 3;
  }).map(function (string) {
    return parseFloat(string);
  }) // Converts them to numbers
  .map(function (number, index) {
    return index === 3 ? Math.round(number * 255) : number;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwilderapartments"] = self["webpackChunkwilderapartments"] || [];
